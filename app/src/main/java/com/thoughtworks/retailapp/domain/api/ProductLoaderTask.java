...
import com.thoughtworks.retailapp.view.adapter.ProductsInCategoryPagerAdapter;
import com.thoughtworks.retailapp.view.fragment.ProductListFragment;
...
public class ProductLoaderTask extends AsyncTask<String, Void, Void> {
    ...
    private void setupViewPager() {
        ...
        for (String string : keys) {
            ...
            bundle.putString("subcategoryKey", string);
            bundle.putBoolean("isShoppingList", false);
