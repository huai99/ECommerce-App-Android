...
import com.thoughtworks.retailapp.view.adapter.SimilarProductsPagerAdapter;
import com.thoughtworks.retailapp.view.customview.ClickableViewPager;
import com.thoughtworks.retailapp.view.customview.ClickableViewPager.OnItemClickListener;
import com.thoughtworks.retailapp.view.customview.LabelView;
import com.thoughtworks.retailapp.view.customview.TextDrawable;
import com.thoughtworks.retailapp.view.customview.TextDrawable.IBuilder;
...
public class ProductDetailsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        this.productListNumber = getArguments().getInt("productListNumber");
        this.isFromCart = getArguments().getBoolean("isFromCart");

        View rootView = inflater.inflate(R.layout.frag_product_detail,
                container, false);

        mAnalyticsHelpers = AnalyticsHelpers.getInstance(getContext());
        ...
        rootView.findViewById(R.id.add_item).setOnClickListener(
                new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        addItem();
                        String itemName = CenterRepository.getCenterRepository()
                        ...
                        String price = Money.rupees(
                                BigDecimal.valueOf(Long.valueOf(CenterRepository
                                        ...
                                        .getSellMRP()))).toString()
                                + "  ";
                        String productID = CenterRepository.getCenterRepository()
                                .getMapOfProductsInCategory().get(subcategoryKey).get(productListNumber)
                                .getProductId();
                        logEvent(AnalyticsHelpers.Event.ADD_TO_CART,
                                ...
                                String.valueOf(1),
                                price);
                        logBeginCheckoutEvent(price, AnalyticsHelpers.Currency.RUPEE);
    ...
    private void removeItem() {
        if (isFromCart) {
            if (Integer.valueOf(CenterRepository
                ...
                if (Integer.valueOf(((ECartHomeActivity) getActivity())
                        .getItemCount()) == 0) {
